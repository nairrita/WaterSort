window.onload = function() {
    ...
    for(let i = 0; i < upper_bound; i++){
        ...
        tube_numbers[i].style.left = (position[i] + tube_width/2) + "px";
    ...
    tButton.addEventListener("click", function() {
        let val_one = document.getElementById("tt-one").value;
        let val_two = document.getElementById("tt-two").value;
        ...
        if(val_one && val_two && val_one != val_two && isValidRange(val_one) && isValidRange(val_two)){
            ...
            window.alert("Please enter valid numbers for the test tubes");
        }
